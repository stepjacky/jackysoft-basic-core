...
public class EncryptData {
	...
	/*
	 * public static void main(String[] args) throws Exception { debug = true; //
	 * byte[] key = getKey(); byte[] key = "好好学习".getBytes();
	 * decode(encode("测试加密".getBytes(), key), key); md5("测试加密".getBytes()); }
	 */
